...
<head>
	...
	<style>
		//@import url(//fonts.googleapis.com/css?family=Lato:700);
                                   @import url(http://fonts.googleapis.com/css?family=Ubuntu:regular&subset=Latin,Cyrillic);
		body {
			margin:0;
...
<body>
	<div class="welcome">
       ...
       $attributes=array('size'=>20,'maxlength'=>5,'height'=>30);
       ?>
                
    <?php
    echo   Form::open(array('url'=>'receive','method'=>'post')); 
    echo  Form::label('username :');
    echo   Form::text('username','jutturong');
    ?>
    <br>
    <?php
     echo    Form::label("email :");
     echo  Form::email('email1','jutturongcharoenrit@gmail.com');
     echo "<br>";
      echo  Form::label('subject :');
     echo  Form::text('subject','mat',$attributes);
          echo "<br>";
